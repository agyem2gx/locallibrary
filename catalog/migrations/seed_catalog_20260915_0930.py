...
def seed_books(apps, schema_editor):
    ...
    computer_science, genre_computer_science_created = Genre.objects.get_or_create(name="Computer Science")
    childrens_humor, genre_childrens_humor_created = Genre.objects.get_or_create(name="Children's Humor")
    science_fiction, genre_science_fiction_created = Genre.objects.get_or_create(name="Science Fiction")
    graphic_novels, genre_graphic_novels_created = Genre.objects.get_or_create(name="Graphic Novels")
    politics, genre_politics_created = Genre.objects.get_or_create(name="Politics")
    food, genre_food_created = Genre.objects.get_or_create(name="Food Science")
    kids, genre_kids_created = Genre.objects.get_or_create(name="Children's Literature")

    snyder, author_snyder_created = Author.objects.get_or_create(first_name="Timothy", last_name="Snyder")
    downey, author_downey_created = Author.objects.get_or_create(first_name="Allen", last_name="Downey")
    novak, author_novak_created = Author.objects.get_or_create(first_name="B. J.", last_name="Novak")
    adams, author_adams_created = Author.objects.get_or_create(first_name="Douglas", last_name="Adams")
    stevenson, author_stevenson_created = Author.objects.get_or_create(first_name="N. D.", last_name="Stevenson")
    hooks, author_hooks_created = Author.objects.get_or_create(first_name="bell", last_name="hooks")
    frye, author_frye_created = Author.objects.get_or_create(first_name="Marilyn", last_name="Frye")
    kenji, author_kenji_created = Author.objects.get_or_create(first_name="J. Kenji", last_name="López-Alt")
